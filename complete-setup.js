 ...
 *
 * This script creates the complete HMS project structure with:
 * - Prisma schema
 * - All API routes
 * - Seed data
 * - Utility functions
...
console.log("🏥 Hospital Management System - Project Setup\n");
...
dirs.forEach((dir) => {
  if (createDir(path.join(basePath, dir))) {
    console.log(`   ✓ ${dir}`);
  }
});
...
writeFile(
  path.join(basePath, "prisma/seed.js"),
